...
{
    // Projeme yükleyeceğim dosyalarla ilgili yükleme,silme,güncelleme işlemlerini bu classında yapıyorum.
    ...
    public class FileHelperManager : IFileHelper
    {
        ...
        public string Upload(IFormFile file, string root)
        {
            ...
            {
                if (!Directory.Exists(root))//Directory=>System.IO'nın bir class'ı. burada ki işlem tam olarak şu. Bu Upload metodumun parametresi olan string root Manager'dan gelmekte
                {                           //ImageManager içerisine girdiğinizde buraya parametre olarak *PathConstants.ImagesPath* böyle bir şey gönderilidğini görürsünüz. PathConstants clası içerisine girdiğinizde string bir ifadeyle bir dizin adresi var
